...
export default function RaggaeTicket() {
	return (
		<>
			<Head>
				<title>Boletaso | Ragg Music</title>
			...
			<main>
				...
				<PageTicketHero
					...
					image='/images/musicPage/banner/Ragg.png'
				/>
				...
				<TrendingSliderWithoutImage
					...
					sliderRef='musicRaggTrendSlider'
				/>
				...
				<ImageSliderNoDetail
					...
					sliderRef='musicRaggCategoriesSlider'
				/>
						...
						<GridContainer>
							<Grid container spacing={8} justifyContent='space-between'>
								<Grid item xs={12} sm={8} md={8}>
									<EventContainer>
										<EventList sectionHeader='All Shows' dataList={raggEventData} />
									</EventContainer>
								</Grid>
